...
def get_DB_range(file):  # file = panels_with_excel[panel][1]
    ...
    db_range = db_sheet.range('W16:AF16')
    return db_range
...
print(f"Директория сканирования файлов DB: {mdb_file}")
...
print(f"Список щитов в директории MDB: {db_list}")
print(
    f"Список щитов в директории MDB совпадающих с отходящими линиями в MDB: {panels_with_excel}")
